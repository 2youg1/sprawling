...
use crate::effect;
use crate::serving::{CommandDesk, Posted, open_vault, random_token};
...
/// drive has returned.
struct Driven {
    outcome: Result<runtime::Run<runtime::run::Frozen>, AxError>,
    ...
    raised: Vec<kernel::ApprovalItem>,
}
...
impl RunWorker {
    ...
    fn lay_out_workbench(
        ...
        let status = self.status_tool(site, desks, addr, mode, budget, &seen, &delegates)?;
